  ...
  return (
    <div className="flex pb-4 border-t">
      ...
      <div className="w-1/2 pt-4">
        <div className="pl-4 pb-4 text-m leading-m border-l h-full">
          <h2 className="uppercase font-bold mb-10">
            {t('contactCity.title')}
          </h2>
          <adress className="w-2/4 inline-block text-xl leading-l font-medium mb-12">
